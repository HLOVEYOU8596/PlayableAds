	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kGrpBg_i(),this.kGrpPeople_i(),this.kGrpSnow_i(),this.kGrpAction_i(),this.kImgSwipe_i(),this.kGrpMenu_i(),this.kImgHand_i(),this.kGrpGuide_i(),this.kGrpEnd_i()];
		return t;
	};
	...
	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg2","kImgTips2","kImgTree1","kImgTree2","kImgTree3","kImgTree4","kImgBg1","kImgPool1","kImgUmbllear1","kImgUmbllear2","kImgCirle1","kImgCirle2","kImgChair1","kImgChair2","kImgSetting2","kImgSetting1","kImgSetting4","kImgSetting3","kGrpBg","kImgPeople","kImgTips","kGrpPeople","kGrpSnow","kGrpAction","kImgSwipe","kImgRight","kImgLine1","kImgLine2","kImgChoice1","kGrpChoice1","kImgChoice2","kGrpChoice2","kGrpMenu","kImgHand","kGrpGuide","kImgEnd","kBtnContinue","kGrpEnd","kGrpMain"];
	...
	_proto.kGrpBg_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kImgBg2_i(),this.kImgTips2_i(),this.kImgTree1_i(),this.kImgTree2_i(),this.kImgTree3_i(),this.kImgTree4_i(),this.kImgBg1_i(),this.kImgPool1_i(),this.kImgUmbllear1_i(),this.kImgUmbllear2_i(),this.kImgCirle1_i(),this.kImgCirle2_i(),this.kImgChair1_i(),this.kImgChair2_i(),this.kImgSetting2_i(),this.kImgSetting1_i(),this.kImgSetting4_i(),this.kImgSetting3_i()];
		return t;
	};
	_proto.kImgBg2_i = function () {
		var t = new eui.Image();
