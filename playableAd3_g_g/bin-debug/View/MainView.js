...
var MainView = (function (_super) {
    ...
    function MainView() {
        ...
        _this.mcArr = [];
        //引导相关变量
        _this.guideArr = [new egret.Point(214, 290), new egret.Point(214, 290), new egret.Point(214, 290),
    ...
    MainView.prototype.playStartAni = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        arrP = [new egret.Point(68, 147), new egret.Point(137, 148), new egret.Point(46, 190), new egret.Point(125, 190)];
                        ...
                        _a = this;
                        return [4 /*yield*/, Dragon.createArmature(0, 15, 'geek', this.kGrpPeople2, geek_ske_j, geek_tex, geek_tex_j)];
                    case 1:
                        _a.geek = (_c.sent());
                        this.geek.animation.play('walk', 1);
                        this.geek.scaleX = this.geek.scaleY = 0.4;
                        egret.Tween.get(this.kGrpPeople2).to({ x: 250 }, 700).call(function () {
    ...
    */
    ...
    MainView.prototype.conacthHam = function () {
        ...
        this.swiperNum++;
        GuideStep.instance.clearHand();
        var arr = [new egret.Point(217, 95), new egret.Point(353, 101), new egret.Point(353, 101)];
        for (var i = 0; i < 3; i++) {
                                        ...
                                        if (this.swiperNum == 2) {
                                            ...
                                            if (!this.end_Card) {
                                                ...
                                                this.setTimeCallBack(2400, function () {
                                                    _this.kGrpMain.setChildIndex(_this.kImgSwipe, 100);
    ...
    MainView.prototype.playEndAni = function () {
        ...
        var rect = new eui.Rect(480, 320, 0x000000);
        rect.fillAlpha = 0.5;
        ...
        this.setTimeCallBack(1500, function () {
            ...
            _this.kImgFood1.x = _this.kImgFood4.x = 580;
            _this.kImgFood2.x = _this.kImgFood3.x = -200;
            _this.kImgTips.y = 350;
            egret.Tween.get(_this.kImgFood1).to({ x: 354 }, 800, egret.Ease.backOut);
            egret.Tween.get(_this.kImgFood2).to({ x: 29 }, 800, egret.Ease.backOut);
            egret.Tween.get(_this.kImgFood3).to({ x: 1 }, 800, egret.Ease.backOut);
            egret.Tween.get(_this.kImgFood4).to({ x: 320 }, 800, egret.Ease.backOut);
            egret.Tween.get(_this.kImgTips).to({ y: 288 }, 800, egret.Ease.sineOut);
            ...
            egret.Tween.get(_this.kImgHand, { loop: true }).to({ y: 226 }, 500).to({ alpha: 0 }, 300).call(function () {
                _this.kImgHand.y = 256;
    ...
    MainView.prototype.playCaidai = function (num, delay) {
        ...
        var _loop_1 = function (i) {
            ...
            var t = egret.setTimeout(function () {
                ...
                egret.Tween.get(img).to({ y: 320 }, 1000).call(function () {
    ...
    MainView.prototype.playYanhua = function () {
        ...
        var tim = egret.setTimeout(function () {
            ...
            img.y = p.y;
            _this.kGrpAction.addChild(img);
            egret.Tween.get(img).to({ scaleX: 1, scaleY: 1 }, 1200, egret.Ease.quadOut).to({ alpha: 0 }, 300).call(function () {
                egret.Tween.removeTweens(img);
                _this.kGrpAction.removeChild(img);
            });
        }, this, t);
