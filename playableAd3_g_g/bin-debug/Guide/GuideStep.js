...
var GuideStep = (function () {
    ...
    GuideStep.prototype.init = function (dp, arr) {
        ...
        this.kImgArrow.anchorOffsetY = 15;
    ...
    GuideStep.prototype.moveHand = function (callBack, type) {
        ...
        this.area.x = point.x - this.area.width + 100;
        this.area.y = point.y - this.area.height + 100;
        this.area.alpha = 0;
        switch (type) {
            case 1:
                ...
                this.kImgCirle.anchorOffsetX = 29;
                this.kImgCirle.anchorOffsetY = 29;
