	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgMenu1","kImgOrder1","kImgOrder2","kGrpMenu1","kGrpPeople1","kImgMenu2","kImgOrder3","kImgOrder4","kGrpMenu2","kGrpPeople2","kImgMenu3","kImgOrder5","kImgOrder6","kGrpMenu3","kGrpPeople3","kImgBg2","kImgBow1","kImgBow2","kImgBow3","kGrpBow","kDrumstick3","kDrumstick6","kDrumstick2","kDrumstick5","kDrumstick4","kDrumstick1","kImgDrumstick1","kImgDrumstick2","kImgDrumstick3","kImgDrumstick4","kImgDrumstick5","kImgDrumstick6","kGrpAction","kImgLux","kImgBox","kGrpEnd","kImgEndBg","kImgFood4","kImgFood2","kImgFood1","kImgFood3","kImgTips","kImgContent","kImgHand","kGrpClose","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kImgBg1_i(),this.kGrpPeople1_i(),this.kGrpPeople2_i(),this.kGrpPeople3_i(),this.kImgBg2_i(),this.kGrpBow_i(),this.kDrumstick3_i(),this.kDrumstick6_i(),this.kDrumstick2_i(),this.kDrumstick5_i(),this.kDrumstick4_i(),this.kDrumstick1_i(),this.kImgDrumstick1_i(),this.kImgDrumstick2_i(),this.kImgDrumstick3_i(),this.kImgDrumstick4_i(),this.kImgDrumstick5_i(),this.kImgDrumstick6_i(),this.kGrpAction_i(),this.kGrpEnd_i(),this.kGrpClose_i(),this.kGrpGuide_i()];
		return t;
	};
