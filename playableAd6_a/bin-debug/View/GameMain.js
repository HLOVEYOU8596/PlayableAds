...
var GameMain = (function (_super) {
    ...
    function GameMain() {
        ...
        _this.peopleNum = 0;
        //引导相关变量
        _this.guideArr = [new egret.Point(382, 442), new egret.Point(657, 665),
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 3:
                        ...
                        this.drumStickArr4.forEach(function (item) { item.source = main_order; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.drumStickArr3.forEach((function (item) {
                    _this.playFei(_this.kGrpMain.getChildIndex(item), item.x - 65, item.y + 20);
    ...
    */
    ...
    GameMain.prototype.onCmplete1 = function () {
        var _this = this;
        GuideStep.instance.clearHand();
        this.setTimeCallBack(0, function () {
            _this.kGrpClose.visible = true;
            _this.kGrpClose.scaleX = 1.126;
            _this.kGrpClose.scaleY = 1.125;
            ...
            egret.Tween.get(_this.kImgTips).to({ y: 560 }, 800, egret.Ease.sineOut).wait(200).call(function () {
                ...
                egret.Tween.get(_this.kImgHand, { loop: true }).to({ x: 918 }, 1000).call(function () {
                    egret.Tween.get(_this.kImgFood1).to({ scaleX: 0.8, scaleY: 0.8 }, 300).wait(300).to({ scaleX: 1, scaleY: 1 }, 100);
                }).wait(500).to({ x: 218 }, 1000).call(function () {
    ...
    GameMain.prototype.clearMc = function () {
        ...
        this.mcArr.forEach(function (item) {
            if (item.parent == _this.kGrpMain)
                _this.kGrpMain.removeChild(item);
            else
