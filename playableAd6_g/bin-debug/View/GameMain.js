...
var GameMain = (function (_super) {
    ...
    function GameMain() {
        ...
        _this.peopleNum = 0;
        //引导相关变量
        _this.guideArr = [new egret.Point(115, 208), new egret.Point(210, 260),
            new egret.Point(220, 192), new egret.Point(309, 254),
            new egret.Point(790, 342),
            // new egret.Point(1032, 546), new egret.Point(942, 350),
            new egret.Point(240, 261)
        ];
        _this.mcArr = [];
        _this.cachSound = {};
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        //初始化人物动画
                        _a = this;
                        return [4 /*yield*/, Dragon.createArmature(50, 110, 'hippies', this.kGrpPeople2, hippies_ske, hippies_tex, hippies_tex_d)];
                    case 1:
                        //初始化人物动画
                        _a.hippies = (_d.sent());
                    ...
                    case 3:
                        ...
                        this.hippies.scaleX = this.hippies.scaleY = this.officelady.scaleX = this.officelady.scaleY = this.geek.scaleX = this.geek.scaleY = .375;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.drumStickArr3.forEach((function (item) {
                    _this.playFei(0, item.x - 25, item.y);
                    _this.playSmog(0, item.x + 25, item.y);
                }));
                //234,500,800
                this.producePeople();
                return [2 /*return*/];
    ...
    */
    ...
    GameMain.prototype.clickSoil = function () {
        ...
        arr.forEach(function (item) { item.x = item.x + 10; });
        this.drumStickArr3.forEach(function (item) {
            egret.Tween.get(item).to({ scaleX: 0, scaleY: 0 }, 300);
        });
        var a = 0;
        var scaleArr = [1, 0.8, 0.7];
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                ...
                                this["kImgOrder" + (a + 1)].scaleX = this["kImgOrder" + (a + 1)].scaleY = .5;
                                return [4 /*yield*/, ParticleUtil.instance.getParticleAtH5(this.kGrpAction, coinJson, coin, arr[a].x, arr[a].y, 700)];
                            case 1:
                                system = _a.sent();
                                system.scaleX = system.scaleY = .375;
    ...
    */
    ...
    GameMain.prototype.showButton = function () {
        ...
        this.kImgTapButton.verticalCenter = 80;
