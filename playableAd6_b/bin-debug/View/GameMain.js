...
var GameMain = (function (_super) {
    ...
    function GameMain() {
        ...
        _this.peopleNum = 0;
        //引导相关变量
        _this.guideArr = [new egret.Point(433, 457), new egret.Point(745, 409),
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        //初始化人物动画
                        _a = this;
                        return [4 /*yield*/, McManger.instance.getMcAtH5('a3', a3_j, a3, 'a3')];
                    case 1:
                        //初始化人物动画
                        _a.hippies = (_d.sent());
                        this.hippies.scaleX = -1;
                        this.hippies.x = 210;
                        this.hippies.y = -35;
                        _b = this;
                    ...
                    case 2:
                        ...
                        this.officelady.scaleX = -1;
                        this.officelady.x = 230;
                    ...
                    case 3:
                        ...
                        this.drumStickArr3.forEach(function (item) { item.source = main_food0; });
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                this.drumStickArr3.forEach((function (item) {
                    _this.playFei(0, item.x - 60, item.y - 3);
                    _this.playSmog(0, item.x + 50, item.y);
                    _this.setProgress(1000, (function (item) {
                        item.source = main_foodz;
                    }).bind(_this, item), item.x - 100, item.y - 100);
                }));
                //234,500,800
                this.producePeople();
                return [2 /*return*/];
    ...
    */
    ...
    GameMain.prototype.showTomoto = function (flag) {
        ...
        tim.once(egret.TimerEvent.TIMER_COMPLETE, function () {
            ...
            GuideStep.instance.moveHand(_this.showHam.bind(_this));
        }, this);
    };
    GameMain.prototype.showHam = function (flag) {
        var _this = this;
        if (flag === void 0) { flag = false; }
        var arr = this.drumStickArr1.concat(this.drumStickArr2);
        var a = 0;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                    ...
                    return __generator(this, function (_a) {
                        if (a == 1) {
                            ...
                            this.setTimeCallBack(1000, function () {
                                ...
                                egret.Tween.get(_this.kGrpPeople1).to({ x: 1280 }, 1000);
                            });
                        }
                        ;
                        if (a == 3) {
                            ...
                            this.setTimeCallBack(1000, function () {
                                ...
                                egret.Tween.get(_this.kGrpPeople2).to({ x: 1280 }, 1000);
                            });
                        }
                ...
                tim.once(egret.TimerEvent.TIMER_COMPLETE, function () {
                    tim.stop();
                    tim = null;
                    _this.geek.gotoAndPlay(1, -1);
                    _this.setTimeCallBack(1000, function () {
                        _this.kGrpMenu3.scaleX = _this.kGrpMenu3.scaleY = 0;
                        egret.Tween.get(_this.kGrpPeople3).to({ x: 1280 }, 400).call(function () {
                            _this.hippies.stop();
                            _this.hippies.gotoAndStop(0);
                            _this.kGrpPeople1.x = -400;
                            _this.kImgOrder1.source = _this.kImgOrder2.source = main_coke3;
                            _this.kImgOrder1.scaleX = _this.kImgOrder1.scaleY = _this.kImgOrder2.scaleX = _this.kImgOrder2.scaleY = .6;
                            egret.Tween.get(_this.kGrpPeople1).to({ x: 540 }, 500).call(function () {
                                GuideStep.instance.moveHand(_this.makeCoke.bind(_this));
                                egret.Tween.get(_this.kGrpMenu1).to({ scaleX: 1, scaleY: 1 }, 400, egret.Ease.elasticOut);
                            });
                        });
                    });
                    // this.onCmplete();
    ...
    */
    ...
    GameMain.prototype.makeCoke = function () {
        var _this = this;
        GuideStep.instance.clearHand();
        this.playStream(600, function () { }, this.kImgCc1.x + 57, this.kImgCc1.y);
        this.playStream(600, function () { }, this.kImgCc2.x + 60, this.kImgCc2.y - 5);
        this.setProgress(600, function () {
            _this.kImgCc1.visible = _this.kImgCc2.visible = false;
            _this.kImgCoke1.source = _this.kImgCoke2.source = main_coke3;
    ...
    GameMain.prototype.playStream = function (t, f, x, y) {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var mm;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, McManger.instance.getMcAtH5('stram', stream_j, stream, "stream")];
                    case 1:
                        mm = _a.sent();
                        ...
                        mm.gotoAndPlay(0);
                        mm.once(egret.Event.COMPLETE, function () {
                            _this.kGrpStream.removeChild(mm);
                            f();
                        }, this);
                        return [2 /*return*/];
                }
