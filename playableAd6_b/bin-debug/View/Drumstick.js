...
var Drumstick = (function (_super) {
    ...
    Drumstick.prototype.initUI = function () {
        ...
        this.kImgDrumstick4.source = main_food4;
        this.kImgDrumstick5.source = main_food5;
    };
    ...
    Drumstick.prototype.showImg1 = function (callBack) {
        var _this = this;
        if (callBack === void 0) { callBack = function () { }; }
        this.kImgDrumstick1.visible = true;
        this.kImgDrumstick1.scaleX = this.kImgDrumstick1.scaleY = 0;
        egret.Tween.get(this.kImgDrumstick1).to({ scaleX: 1, scaleY: 1 }, 600, egret.Ease.elasticOut).call(function () {
            egret.Tween.removeTweens(_this.kImgDrumstick1);
            callBack();
        });
    };
    ...
    Drumstick.prototype.showImg5 = function (callBack) {
        ...
        egret.Tween.get(this.kImgDrumstick5).to({ scaleX: 1, scaleY: 1 }, 600, egret.Ease.elasticOut).call(function () {
