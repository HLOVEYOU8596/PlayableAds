...
class Drumstick extends eui.Component implements eui.UIComponent{
    ...
    private initUI(){
        ...
        this.kImgLocked.source = main_suo;
    }
    ...
    public showImg4(callBack:Function = ()=>{}){
        ...
        egret.Tween.get(this.kImgDrumstick4).to({scaleX:1,scaleY:1},600,egret.Ease.elasticOut).call(()=>{
    ...
    public showImg5(callBack:Function = ()=>{}){
        ...
        egret.Tween.get(this.kImgDrumstick5).to({ y: 18.5 }, 500, egret.Ease.circIn).call(() => {
