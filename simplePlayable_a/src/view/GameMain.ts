...
class GameMain extends eui.Component implements eui.UIComponent {
    ...
    private touchFirst() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 456, y: 448 }, 300, egret.Ease.sineOut).call(() => {
    ...
    private touchSecond() {
        ...
        // this.setStream(600, () => {
            this.setTimeCallBack(600,()=>{
                // this.kImgCoke.source = main_coke3;
                egret.Tween.get(this.kImgCoke).to({ x: 920, y: 558, scaleX: 1, scaleY: 1 }, 300, egret.Ease.sineOut);
            })
        // }, 908, 660);
    ...
    private touchFifth() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 715, y: 175, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.playFlyCoin(new egret.Point(680, 235), new egret.Point(395, 0), () => {
