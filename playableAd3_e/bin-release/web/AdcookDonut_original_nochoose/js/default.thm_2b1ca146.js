	...
	function DrumstickDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgDrumstick1","kImgDrumstick3","kImgDrumstick4","kImgDrumstick5"];
	...
	_proto._Group1_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kImgDrumstick1_i(),this.kImgDrumstick3_i(),this.kImgDrumstick4_i(),this.kImgDrumstick5_i()];
		return t;
	};
	...
	function MainViewDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgPeople1","kImgMenu1","kImgNum1","kGrpMenu1","kGrpPeople1","kImgPeople2","kImgMenu2","kImgNum2","kGrpMenu2","kGrpPeople2","kImgbg2","kImgD1","kImgD2","kImgD3","kImgD4","kGrpBg","kGrpAction","kGrpHam","kImgArrow","kGrpSnow","kImgSwipe","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpBg_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kImgBg1_i(),this.kGrpPeople1_i(),this.kGrpPeople2_i(),this.kImgbg2_i(),this.kImgD1_i(),this.kImgD2_i(),this.kImgD3_i(),this.kImgD4_i()];
		return t;
	};
	...
	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgPeople1","kImgMenu1","kImgNum1","kGrpMenu1","kGrpPeople1","kImgPeople2","kImgMenu2","kImgNum2","kGrpMenu2","kGrpPeople2","kImgbg2","kImgD1","kImgD2","kImgD3","kImgD4","kGrpBg","kGrpAction","kGrpHam","kGrpSnow","kImgSwipe","kGrpGuide","kGrpMain"];
