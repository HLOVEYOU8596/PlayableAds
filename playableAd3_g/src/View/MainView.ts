...
class MainView extends eui.Component implements eui.UIComponent {
    ...
    //引导相关变量
    private guideArr = [new egret.Point(583, 664), new egret.Point(583, 664), new egret.Point(583, 664),
    ...
    */
    ...
    private async playStartAni() {
        ...
        let arrP: egret.Point[] = [new egret.Point(260, 324), new egret.Point(404, 324), new egret.Point(204, 416), new egret.Point(376, 416)];

        arrP.forEach(async item => {
            let a1 = <egret.MovieClip>await McManger.instance.getMcAtH5('noodle', noodle_j, noodle, 'noodle');
            a1.x = item.x+3; a1.y = item.y - 7;
