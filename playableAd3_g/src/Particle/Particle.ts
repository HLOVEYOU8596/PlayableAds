...
class ParticleUtil {
    ...
    public creatParticle(_pname: string, _target, _x: number = 0, _y: number = 0, t: number = 0) {
        ...
        _particle.x = _x;
        _particle.y = _y;
        if (t) _particle.start(t);
        else _particle.start();
        return _particle;
    }

    public async getParticleAtH5(_target: eui.Group, data: Object, url: string, _x: number=0, _y: number=0,t:number=0) {
