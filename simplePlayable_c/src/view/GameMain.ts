...
class GameMain extends eui.Component implements eui.UIComponent {
    ...
    private kImgDisk: eui.Image;
    private kGrpA:eui.Group;
    private kGrpB:eui.Group;
    ...
    private adType: Number = AD_TYPE.tap2;
    private qie:egret.MovieClip;

    private guideArr = [new egret.Point(460, 624),
    ...
    private async playStartAni() {
        ...
        this.aunt = <egret.MovieClip>await McManger.instance.getMcAtH5('laugh',gramma_j,gramma,'laugh');
        this.aunt.x = 50;
    ...
    private async touchFirst() {
        ...
        let qie:egret.MovieClip = <egret.MovieClip>await McManger.instance.getMcAtH5('cishen',cishen_j,cishen,'cishen');
        ...
        this.qie = qie;
        qie.gotoAndPlay(0);
        this.setProgress(1200, () => {
            GuideStep.instance.moveHand(this.touchSecond.bind(this));
            this.kGrpFood.removeChild(this.qie);
            this.kImgDrumstick.visible = true;
    ...
    private touchSecond() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 530, y: 450 }, 300).call(()=>{
            this.kImgDrumstick.source = main_drumstick_1;
            this.kImgDisk.visible = true;
        });
        ...
        this.setTimeCallBack(600, () => {
            // this.kImgCoke.source = main_coke3;
            egret.Tween.get(this.kImgCoke).to({ x: 1082, y: 442, scaleX: 1, scaleY: 1 }, 300, egret.Ease.sineOut);
        })
        // }, 908, 660);
    ...
    private touchFifth() {
        ...
        if (this.adType === AD_TYPE.tap2) { this.setTimeCallBack(1000,this.showButton.bind(this));};
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kGrpFood).to({ x: 740, y: 180, scaleX: 0.4, scaleY: 0.4 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.playFlyCoin(new egret.Point(730, 220), new egret.Point(395, 0), () => {
    ...
    private touchSixth() {
        ...
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kImgCoke).to({ x: 525, y: 150, scaleX: 0.5, scaleY: 0.5 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.playFlyCoin(new egret.Point(515, 235), new egret.Point(395, 0), () => {
                this.kProgress.value += 50;
                // this.geek.animation.reset();
