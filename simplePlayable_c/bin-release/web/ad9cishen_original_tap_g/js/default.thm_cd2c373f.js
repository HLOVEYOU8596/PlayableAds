	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kImgMenu2","kImgOrder2","kImgCoin2","kGrpMenu2","kGrpA","kGrpPeople2","kImgMenu1","kImgOrder1","kImgCoin1","kGrpMenu1","kGrpB","kGrpPeople1","kImgCoke","kImgDisk","kImgDrumstick","kImgShu","kImgFan","kGrpFood","kGrpAction","kImgTopic","kLbTopic","kImgEndBg","kImgLogo1","kImgLogo2","kImgHand","kGrpClose","kGrpEnd","kImgXu","kLbTips","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpClose_i = function () {
		...
		t.visible = false;
		t.width = 1280;
		t.elementsContent = [this.kImgEndBg_i(),this._Group1_i(),this.kImgHand_i()];
		return t;
	};
