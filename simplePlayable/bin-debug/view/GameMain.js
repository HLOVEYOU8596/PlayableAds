...
var GameMain = (function (_super) {
    ...
    GameMain.prototype.touchFirst = function () {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 442, y: 468 }, 300, egret.Ease.sineOut).call(function () {
            _this.playFei(0, _this.kGrpFood.x - 60, _this.kGrpFood.y - 20);
    ...
    GameMain.prototype.touchSecond = function () {
        ...
        this.setStream(600, function () {
            ...
            egret.Tween.get(_this.kImgCoke).to({ x: 870, y: 350, scaleX: 1, scaleY: 1 }, 300, egret.Ease.sineOut);
        }, 908, 660);
    ...
    GameMain.prototype.touchFifth = function () {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 715, y: 175, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineOut).call(function () {
            ...
            _this.playFlyCoin(new egret.Point(705, 235), new egret.Point(395, 0), function () {
