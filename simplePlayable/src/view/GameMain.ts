...
class GameMain extends eui.Component implements eui.UIComponent {
    ...
    private guideArr = [new egret.Point(310, 624),
    new egret.Point(448, 466),
    new egret.Point(596, 580),
    new egret.Point(763, 580),
    new egret.Point(680, 450),
    new egret.Point(886, 400)];
    ...
    private touchFirst() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 442, y: 468 }, 300, egret.Ease.sineOut).call(() => {
    ...
    private touchSecond() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 680, y: 450 }, 300);
        ...
        this.setStream(600, () => {
            ...
            egret.Tween.get(this.kImgCoke).to({ x: 870, y: 350, scaleX: 1, scaleY: 1 }, 300, egret.Ease.sineOut);
        }, 908, 660);
    ...
    private touchFifth() {
        ...
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kGrpFood).to({ x: 715, y: 175, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.playFlyCoin(new egret.Point(705, 235), new egret.Point(395, 0), () => {
