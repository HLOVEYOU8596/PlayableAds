...
var MainView = (function (_super) {
    ...
    function MainView() {
        ...
        _this.mcArr = [];
        _this.guideStep = 0;
        _this.arr = [new egret.Point(250, 544),
    ...
    MainView.prototype.playStartAni = function () {
        var _this = this;
        this.playBgm();
        egret.Tween.get(this.kImgMan).to({ x: 840 }, 600, egret.Ease.cubicOut).call(function () {
            ...
            //下雪了，想必雪人也会冷的吧
            ParticleUtil.instance.getParticleAtH5(_this.kGrpSnow, snowJson, snow, 0, 0);
        });
    ...
    MainView.prototype.touchFirst = function () {
        ...
        egret.Tween.get(this.kImgFood1).to({ x: 220, y: 380 }, 400, egret.Ease.sineIn).call(function () {
            //TODO  播放进度条代码，传入回调
            _this.playSmog(1000, 240, 380);
    ...
    MainView.prototype.touchSecond = function () {
        ...
        this.clearMc();
        this.soil.close();
        egret.Tween.get(this.kImgFood1).to({ x: 470, y: 300 }, 400, egret.Ease.sineOut).call(function () {
            // this.kImgFood1.source = main_drumstick_2;
            _this.kImgFood1.visible = false;
            _this.kImgFood3.source = main_drumstick_3;
            egret.Tween.get(_this.kImgWoman).to({ x: 300 }, 400, egret.Ease.cubicOut).call(function () {
                ...
                _this.setProgress(1000, function () {
                    egret.Tween.get(_this.kImgFood2).to({ x: 930, y: 450, scaleX: 1, scaleY: 1 }, 400, egret.Ease.sineIn).call(function () { _this.playBubble(930, 470); _this.soundBubble(); });
    ...
    MainView.prototype.touchFouth = function () {
        var _this = this;
        this.guide.clearHand();
        egret.Tween.get(this.kImgFood3).to({ x: 680, y: 154 }, 300, egret.Ease.sineOut).to({ scaleX: 0.5, scaleY: 0.5 }, 100).wait(100).call(function () {
            _this.kImgFood3.visible = false;
    ...
    MainView.prototype.onCompleteFood = function () {
        ...
        egret.Tween.get(this.kImgFood2).to({ x: 420, y: 142 }, 300, egret.Ease.sineOut).to({ scaleX: 0.7, scaleY: 0.7 }, 100).wait(100).call(function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, ParticleUtil.instance.getParticleAtH5(this.kGrpAction, smJson, sm, -200, -160)];
                    case 1:
                        _a.system = (_b.sent());
