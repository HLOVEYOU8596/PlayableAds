	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgMenu1","kImgOrder1","kGrpMenu1","kGrpPeople1","kImgMenu2","kImgOrder2","kGrpMenu2","kGrpPeople2","kImgMenu3","kImgOrder3","kGrpMenu3","kGrpPeople3","kImgBg2","kDrumstick3","kDrumstick6","kDrumstick2","kDrumstick5","kDrumstick4","kDrumstick1","kImgDrumstick1","kImgDrumstick2","kImgDrumstick3","kImgDrumstick4","kImgDrumstick5","kImgDrumstick6","kGrpAction","kImgLux","kImgBox","kGrpEnd","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpMenu2_i = function () {
		...
		t.x = 188;
		t.y = 130;
		t.elementsContent = [this.kImgMenu2_i(),this.kImgOrder2_i()];
		return t;
	};
	...
	_proto.kGrpMenu3_i = function () {
		...
		t.x = 146;
		t.y = 132;
		t.elementsContent = [this.kImgMenu3_i(),this.kImgOrder3_i()];
		return t;
	};
