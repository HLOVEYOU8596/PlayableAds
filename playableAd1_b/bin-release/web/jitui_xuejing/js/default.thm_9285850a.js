	...
	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kGrpBg","kImgWoman","kImgMan","main_drumstick_1","kImgBg2","kGrpProgress","kGrpAction","kImgAlert0","kImgRight0","kImgCoin0","kGrpAlert0","kImgAlert","kImgRight","kImgCoin","kGrpAlert","kGrpCoin","kRect","kGrpRect","kImgFood1","kImgFu","kImgXu","kImgFood2","main_reward_bg","kLbEnd","kImgBg3","kImgTopic","kImgLogo1","kImgLogo2","kGrpBg3","kGrpEnd","kImgArrow","kGrpGuide"];
		
		this.height = 640;
		this.width = 1136;
		this.elementsContent = [this.kGrpBg_i(),this._Group1_i(),this.kImgBg2_i(),this.kGrpProgress_i(),this.kGrpAction_i(),this.kGrpAlert0_i(),this.kGrpAlert_i(),this.kGrpCoin_i(),this.kGrpRect_i(),this.kImgFood1_i(),this.kImgFu_i(),this.kImgXu_i(),this.kImgFood2_i(),this.kGrpEnd_i(),this.kImgArrow_i(),this.kGrpGuide_i()];
	}
	...
	_proto.kGrpBg3_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this.kImgBg3_i(),this.kImgTopic_i(),this._Group2_i()];
		return t;
	};
	...
	_proto.kImgTopic_i = function () {
		var t = new eui.Image();
		this.kImgTopic = t;
		t.anchorOffsetX = 462.12;
		t.anchorOffsetY = 125.76;
		t.height = 265;
