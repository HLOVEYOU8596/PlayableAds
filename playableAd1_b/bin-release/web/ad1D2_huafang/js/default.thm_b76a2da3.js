	...
	_proto._Group3_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1136;
		t.elementsContent = [this.kGrpBg_i(),this._Group1_i(),this.kImgBg2_i(),this.kGrpProgress_i(),this.kGrpAction_i(),this.kGrpAlert0_i(),this.kGrpAlert_i(),this.kGrpSnow_i(),this.kGrpCoin_i(),this.kGrpRect_i(),this.kImgFood1_i(),this.kImgFu_i(),this.kImgXu_i(),this.kImgFood2_i(),this.kGrpEnd_i(),this.kImgArrow_i(),this.kGrpGuide_i()];
		return t;
	};
