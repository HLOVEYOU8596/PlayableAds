    ...
    GuideStep.prototype.moveHand = function (callBack, type) {
        ...
        switch (type) {
            case 1:
                ...
                egret.Tween.get(this.kImgCirle, { loop: true }).to({ scaleX: 1.6, scaleY: 1.6 }, 300, egret.Ease.quadInOut)
                ...
                egret.Tween.get(this.kImgArrow, { loop: true }).
                    to({ scaleX: 1.2, scaleY: 1.2 }, 500, egret.Ease.quartInOut)
