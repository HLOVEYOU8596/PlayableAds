...
class GameMain extends eui.Component implements eui.UIComponent {
    ...
    private touchFirst() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 402, y: 468 }, 300, egret.Ease.sineOut).call(() => {
    ...
    private touchSecond() {
        ...
        this.setStream(600, () => {
            ...
            egret.Tween.get(this.kImgCoke).to({ x: 920, y: 420, scaleX: 2, scaleY: 2 }, 300, egret.Ease.sineOut);
        }, 968, 660);
    ...
    private touchFifth() {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 715, y: 175, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.playFlyCoin(new egret.Point(705, 255), new egret.Point(395, 0), () => {
    ...
    private touchSixth() {
        ...
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kImgCoke).to({ x: 525, y: 150, scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.playFlyCoin(new egret.Point(515, 255), new egret.Point(395, 0), () => {
                this.kProgress.value += 50;
                this.geek.animation.reset();
