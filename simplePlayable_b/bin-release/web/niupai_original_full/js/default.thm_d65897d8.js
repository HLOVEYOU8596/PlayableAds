	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kImgMenu2","kImgOrder2","kImgCoin2","kGrpMenu2","kGrpPeople2","kImgMenu1","kImgOrder1","kImgCoin1","kGrpMenu1","kGrpPeople1","kImgCoke","kImgFan","kImgShu","kImgDrumstick","kGrpFood","kGrpAction","kImgTopic","kLbTopic","kImgEndBg","kImgFood4","kImgFood2","kImgFood1","kImgFood3","kImgTips","kImgContent","kImgHand","kGrpClose","kGrpEnd","kImgXu","kLbTips","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpFood_i = function () {
		...
		t.x = 318;
		t.y = 647.63;
		t.elementsContent = [this.kImgFan_i(),this.kImgShu_i(),this.kImgDrumstick_i()];
		return t;
	};
