...
var GameMain = (function (_super) {
    ...
    function GameMain() {
        ...
        _this.guideArr = [new egret.Point(360, 624),
            ...
            new egret.Point(596, 600),
            new egret.Point(763, 600),
            new egret.Point(680, 450),
            new egret.Point(940, 400)];
    ...
    GameMain.prototype.touchFirst = function () {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 402, y: 468 }, 300, egret.Ease.sineOut).call(function () {
    ...
    GameMain.prototype.touchSecond = function () {
        ...
        this.setStream(600, function () {
            ...
            egret.Tween.get(_this.kImgCoke).to({ x: 920, y: 420, scaleX: 2, scaleY: 2 }, 300, egret.Ease.sineOut);
        }, 968, 660);
    ...
    GameMain.prototype.touchFifth = function () {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 715, y: 175, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineOut).call(function () {
            ...
            _this.playFlyCoin(new egret.Point(705, 255), new egret.Point(395, 0), function () {
    ...
    GameMain.prototype.touchSixth = function () {
        ...
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kImgCoke).to({ x: 525, y: 150, scaleX: 1.5, scaleY: 1.5 }, 300, egret.Ease.sineOut).call(function () {
            ...
            _this.playFlyCoin(new egret.Point(515, 255), new egret.Point(395, 0), function () {
                _this.kProgress.value += 50;
                _this.geek.animation.reset();
            ...
            return __generator(this, function (_g) {
                switch (_g.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, Dragon.getImageData(main_coke2)];
                    case 1:
