...
var MainView = (function (_super) {
    ...
    MainView.prototype.touchSecond = function () {
        ...
        //x:450,y:336
        egret.Tween.get(this.kImgFood1).to({ x: 430, y: 356 }, 300, egret.Ease.sineOut).call(function () {
            ...
            egret.Tween.get(_this.kImgWoman).to({ x: 300 }, 400, egret.Ease.cubicOut).call(function () {
                ...
                _this.setProgress(400, function () {
                    egret.Tween.get(_this.kImgFood2).to({ x: 884, y: 329, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineIn);
    ...
    MainView.prototype.playEndAni = function () {
        ...
        this.playYanhua();
        this.playYanhua();
        egret.Tween.get(this.kLbEnd).to({ alpha: 0 }, 500).wait(1500).call(function () {
