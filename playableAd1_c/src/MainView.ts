...
//520，420
    ...
    private touchSecond() {
        ...
        //x:450,y:336
        egret.Tween.get(this.kImgFood1).to({ x: 430, y: 356 }, 300, egret.Ease.sineOut).call(() => {
            ...
            egret.Tween.get(this.kImgWoman).to({ x: 300 }, 400, egret.Ease.cubicOut).call(() => {
                ...
                this.setProgress(400, () => {
                    egret.Tween.get(this.kImgFood2).to({ x: 884, y: 329, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineIn);
    ...
    private playEndAni() {
        ...
        egret.Tween.get(this.kLbEnd).to({ alpha: 0 }, 500).wait(1500).call(() => {
