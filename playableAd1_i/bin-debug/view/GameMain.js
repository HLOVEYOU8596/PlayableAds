...
var GameMain = (function (_super) {
    ...
    function GameMain() {
        ...
        _this.guideArr = [new egret.Point(350, 504),
    ...
    GameMain.prototype.playStartAni = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                egret.Tween.get(this.kGrpPeople1).to({ x: 650 }, 500, egret.Ease.sineOut).call(function () {
    ...
    GameMain.prototype.touchFirst = function () {
        ...
        egret.Tween.get(this.kGrpFood).to({ x: 330, y: 448 }, 300, egret.Ease.sineOut).call(function () {
            _this.playFei(0, _this.kGrpFood.x - 10, _this.kGrpFood.y - 30);
            _this.playSmog(0, _this.kGrpFood.x + 60, _this.kGrpFood.y - 40);
    ...
    GameMain.prototype.touchSecond = function () {
        ...
        egret.Tween.get(this.kGrpPeople2).to({ x: 230 }, 300, egret.Ease.sineOut).call(function () {
        ...
        this.setStream(600, function () {
            _this.kImgCoke.source = main_coke3;
            egret.Tween.get(_this.kImgCoke).to({ x: 900, y: 400, scaleX: 1, scaleY: 1 }, 300, egret.Ease.sineOut);
        }, 1280, 1280);
    ...
    GameMain.prototype.touchFifth = function () {
        ...
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kGrpFood).to({ x: 715, y: 175 - 60, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineOut).call(function () {
            ...
            _this.playFlyCoin(new egret.Point(705 + 3, 235 - 50), new egret.Point(395, 0), function () {
                _this.kProgress.value += 50;
                // this.aunt.animation.reset();
                // this.aunt.animation.play('happy',0);
                _this.aunt.source = main_aunt_laugh;
    ...
    GameMain.prototype.touchSixth = function () {
        ...
        GuideStep.instance.clearHand();
        egret.Tween.get(this.kImgCoke).to({ x: 525, y: 150 - 40, scaleX: 0.5, scaleY: 0.5 }, 300, egret.Ease.sineOut).call(function () {
            ...
            _this.playFlyCoin(new egret.Point(515 - 3, 235 - 39), new egret.Point(395, 0), function () {
                _this.kProgress.value += 50;
                // this.geek.animation.reset();
                // this.geek.animation.play('happy',0);
                _this.geek.source = main_gramma_laugh;
    ...
    GameMain.prototype.playEndAni = function () {
        ...
        this.setTimeCallBack(0, function () {
            // this.setTimeCallBack(1500, () => {
            _this.kGrpClose.visible = true;
            //2,3 90 28  1,4 964,861  tip:634
            _this.kImgHand.visible = false;
            egret.Tween.get(_this.kImgFood1).to({ x: 770 + 172 - 60 }, 800, egret.Ease.backOut);
            // egret.Tween.get(this.kImgFood2).to({ x: 380+59 }, 800, egret.Ease.backOut);
            egret.Tween.get(_this.kImgFood3).to({ x: 50 + 195 + 40 }, 800, egret.Ease.backOut);
            // egret.Tween.get(this.kImgFood4).to({ x: 663+53 }, 800, egret.Ease.backOut);
            var a = 0;
            egret.Tween.get(_this.kImgTips).to({ y: 560 }, 800, egret.Ease.sineOut).wait(200).call(function () {
                _this.kImgHand.visible = true;
                egret.Tween.get(_this.kImgHand, { loop: true }).to({ x: 936 }, 1000).call(function () {
                    egret.Tween.get(_this.kImgFood1).to({ scaleX: 0.8, scaleY: 0.8 }, 300).wait(300).to({ scaleX: 1, scaleY: 1 }, 100);
                }).wait(500).to({ x: 200 }, 1000).call(function () {
                    egret.Tween.get(_this.kImgFood3).to({ scaleX: 0.8, scaleY: 0.8 }, 300).wait(300).to({ scaleX: 1, scaleY: 1 }, 100);
                }).wait(500);
            });
