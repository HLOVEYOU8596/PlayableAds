		...
		this.states = [
			new eui.State ("state1",
				[
					...
					new eui.SetProperty("kImgHam4","horizontalCenter",0),
	...
	function HamburgSkin() {
		...
		this.states = [
			new eui.State ("state1",
				[
					new eui.SetProperty("kImgHam1","horizontalCenter",0),
					new eui.SetProperty("kImgHam2","y",145),
					new eui.SetProperty("kImgHam2","horizontalCenter",0),
					new eui.SetProperty("kImgHam3","y",128),
					new eui.SetProperty("kImgHam3","visible",false),
					...
					new eui.SetProperty("kImgHam5","anchorOffsetY",64),
					new eui.SetProperty("kImgHam5","visible",false),
					new eui.SetProperty("kGrpMaster","left",0),
					new eui.SetProperty("kGrpMaster","right",0),
					new eui.SetProperty("kGrpMaster","top",0),
					new eui.SetProperty("kGrpMaster","bottom",0),
					new eui.SetProperty("kGrpMaster","anchorOffsetX",99),
					new eui.SetProperty("kGrpMaster","anchorOffsetY",113)
				])
		];
	}
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kGrpBg_i(),this.kGrpHam_i(),this.kImgArrow_i(),this.kGrpSnow_i(),this.kImgSwipe_i(),this.kGrpGuide_i()];
		return t;
	};
	...
	_proto.kGrpHam_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kGrpAction_i()];
		return t;
	};
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kGrpBg_i(),this.kGrpHam_i(),this.kGrpSnow_i(),this.kImgSwipe_i(),this.kGrpGuide_i()];
		return t;
	};
	_proto.kGrpBg_i = function () {
		var t = new eui.Group();
