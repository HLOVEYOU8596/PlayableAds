...
class MainView extends eui.Component implements eui.UIComponent {
    ...
    //引导相关变量
    private guideArr = [new egret.Point(779, 625), new egret.Point(779, 625), new egret.Point(779, 625),
    new egret.Point(914, 625), new egret.Point(914, 625), new egret.Point(914, 625),
    new egret.Point(630, 625), new egret.Point(516, 456), new egret.Point(556, 260),
    new egret.Point(697, 456), new egret.Point(648, 254), new egret.Point(929, 456),
    new egret.Point(792, 264),
    ];
