...
class MainView extends eui.Component implements eui.UIComponent {
    ...
    //引导相关变量
    private guideArr = [new egret.Point(543, 664), new egret.Point(543, 664), new egret.Point(543, 664),
    new egret.Point(763, 664), new egret.Point(763, 664), new egret.Point(763, 664),
    new egret.Point(981, 664),
    new egret.Point(526, 534), new egret.Point(550, 274), new egret.Point(740, 536),
    new egret.Point(720, 276), new egret.Point(964, 524), new egret.Point(870, 284),];
    ...
    */
    ...
    private async playStartAni() {
        ...
        //281 697
        this.playSmog(0, 181, 333);
        this.playSmog(0, 357, 336);
        this.playSmog(0, 103, 463);
        this.playSmog(0, 312, 463);
        this.geek = <dragonBones.EgretArmatureDisplay>await Dragon.createArmature(0, 30, 'geek', this.kGrpPeople2, geek_ske_j, geek_tex, geek_tex_j);
    ...
    private playCaidai(num: number, delay: number) {
        ...
        for (let i = 0; i < num; i++) {
            ...
            let t = egret.setTimeout(() => {
                ...
                egret.Tween.get(img).to({ y: this.stage.height }, 1000).call(() => {
