	...
	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["rect","kImgBg1","kGrpBg","kImgWoman","kImgMan","main_drumstick_1","kImgBg2","kGrpProgress","kGrpAction","kImgAlert0","kImgRight0","kImgCoin0","kGrpAlert0","kImgAlert","kImgRight","kImgCoin","kGrpAlert","kGrpCoin","kRect","kGrpRect","kImgFood1","kImgFu","kImgXu","kImgFood2","main_reward_bg","kLbEnd","kImgBg3","kImgTopic","kImgPlay","kGrpBg3","kGrpEnd","kImgArrow","kGrpGuide","kImgPlayNow"];
		
		this.height = 640;
		this.width = 1136;
		this.elementsContent = [this.rect_i(),this._Group2_i()];
	}
	...
	_proto._Group2_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1136;
		t.elementsContent = [this.kGrpBg_i(),this._Group1_i(),this.kImgBg2_i(),this.kGrpProgress_i(),this.kGrpAction_i(),this.kGrpAlert0_i(),this.kGrpAlert_i(),this.kGrpCoin_i(),this.kGrpRect_i(),this.kImgFood1_i(),this.kImgFu_i(),this.kImgXu_i(),this.kImgFood2_i(),this.kGrpEnd_i(),this.kImgArrow_i(),this.kGrpGuide_i(),this.kImgPlayNow_i()];
		return t;
	};
	...
	_proto.kGrpEnd_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this._Rect1_i(),this.main_reward_bg_i(),this.kLbEnd_i(),this.kGrpBg3_i()];
		return t;
	};
	...
	_proto.kGrpBg3_i = function () {
		...
		t.top = 0;
		t.visible = false;
		t.elementsContent = [this.kImgBg3_i(),this.kImgTopic_i(),this.kImgPlay_i()];
		return t;
	};
