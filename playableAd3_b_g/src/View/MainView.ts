...
class MainView extends eui.Component implements eui.UIComponent {
    ...
    //引导相关变量
    private guideArr = [new egret.Point(304, 277), new egret.Point(304, 277), new egret.Point(304, 277),
    ...
    */
    ...
    private playStartAni() {
        ...
        this.setTimeCallBack(500, () => {
            egret.Tween.get(this.kGrpPeople1).to({ x: 80 }, 280).call(() => {
    ...
    */
    ...
    private conacthHam() {
        this.swiperNum++;
        GuideStep.instance.clearHand();
        let coinPoint = [new egret.Point(188, 56), new egret.Point(368, 56)];
        let arr = [new egret.Point(177, 132), new egret.Point(241, 132), new egret.Point(241, 132)];
        for (let i = 0; i < 3; i++) {
        ...
        this.setTimeCallBack(160, async () => {
            ...
            egret.Tween.get(this.hamArr[9 - this.swiperNum]).to({ x: this.swiperNum == 1 ? 188 : 368, y: 56, scaleX: 0.6, scaleY: 0.6 }, 150).call(() => {
            ...
            let x = await ParticleUtil.instance.getParticleAtH5(this.kGrpSnow, coinJson, coin, coinPoint[this.swiperNum - 1].x, coinPoint[this.swiperNum - 1].y, 700);
            ...
            this.setTimeCallBack(700, () => {
                ...
                if (this.swiperNum == 1) {
                    ...
                    this.setTimeCallBack(2400, () => {
                        ...
                        egret.Tween.get(this.kImgSwipe).to({ scaleX: .8, scaleY: .8 }, 700, egret.Ease.elasticOut).call(() => {
                            egret.Tween.removeTweens(this.kImgSwipe);
                            egret.Tween.get(this.kImgSwipe, { loop: true }).to({ scaleX: 1, scaleY: 1 }, 600).to({ scaleX: .8, scaleY: .8 }, 100);
                        });
                    })
                }
            })
