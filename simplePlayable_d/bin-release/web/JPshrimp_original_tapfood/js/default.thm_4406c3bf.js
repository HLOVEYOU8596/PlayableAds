	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgMenu2","kImgOrder2","kImgCoin2","kGrpMenu2","kGrpPeople2","kImgMenu1","kImgOrder1","kImgCoin1","kGrpMenu1","kGrpPeople1","kImgBg2","kImgBig","kImgCoke","kImgShu","kImgDrumstick","kImgFan","kGrpFood","kGrpAction","kImgTopic","kLbTopic","kImgEndBg","kImgFood4","kImgFood2","kImgFood1","kImgFood3","kImgTips","kImgContent","kImgHand","kGrpClose","kGrpEnd","kImgXu","kLbTips","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kImgBg1_i(),this.kGrpPeople2_i(),this.kGrpPeople1_i(),this.kImgBg2_i(),this.kImgBig_i(),this.kImgCoke_i(),this.kGrpFood_i(),this.kGrpAction_i(),this.kGrpEnd_i(),this.kImgXu_i(),this.kLbTips_i(),this.kGrpGuide_i()];
		return t;
	};
