	...
	function GameMainDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgMenu2","kImgOrder2","kImgCoin2","kGrpMenu2","kGrpPeople2","kImgMenu1","kImgOrder1","kImgCoin1","kGrpMenu1","kGrpPeople1","kImgBg2","kImgBig","kImgCoke","kImgCoke0","kImgCoke1","kImgShu","kImgDrumstick","kImgFan","kGrpFood","kGrpAction","kImgTopic","kLbTopic","kImgEndBg","kImgFood4","kImgFood2","kImgFood1","kImgFood3","kImgTips","kImgContent","kImgHand","kGrpClose","kGrpEnd","kImgXu","kLbTips","kGrpGuide","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kImgBg1_i(),this.kGrpPeople2_i(),this.kGrpPeople1_i(),this.kImgBg2_i(),this.kImgBig_i(),this.kImgCoke_i(),this.kImgCoke0_i(),this.kImgCoke1_i(),this.kGrpFood_i(),this.kGrpAction_i(),this.kGrpEnd_i(),this.kImgXu_i(),this.kLbTips_i(),this.kGrpGuide_i()];
		return t;
	};
	...
	_proto.kImgCoke_i = function () {
		var t = new eui.Image();
		this.kImgCoke = t;
		t.anchorOffsetX = 23.78;
		t.anchorOffsetY = 26.22;
		t.source = "";
		t.x = 924.85;
		t.y = 496.97;
		return t;
	};
	_proto.kImgCoke0_i = function () {
		var t = new eui.Image();
		this.kImgCoke0 = t;
		t.anchorOffsetX = 23.78;
		t.anchorOffsetY = 26.22;
	...
	_proto.kGrpFood_i = function () {
		...
		this.kGrpFood = t;
		t.anchorOffsetX = 104;
		t.anchorOffsetY = 81.63;
		t.height = 154.33;
		t.visible = false;
		t.width = 201;
		t.x = 318;
		t.y = 647.63;
		t.elementsContent = [this.kImgShu_i(),this.kImgDrumstick_i(),this.kImgFan_i()];
		return t;
	};
