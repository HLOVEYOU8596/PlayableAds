	...
	function MainViewDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kImgDecorate3","kImgMain","kImgDecorate1","kImgDecorate2","kGrpSnow","kBtn1","kBtn2","kBtn3","kGrpBtn","kGrpAction","kGrpGuide","kImgTipsBg","kImgTips","kGrpTips","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kImgBg_i(),this.kImgDecorate3_i(),this.kImgMain_i(),this.kImgDecorate1_i(),this.kImgDecorate2_i(),this.kGrpSnow_i(),this.kGrpBtn_i(),this.kGrpAction_i(),this.kGrpGuide_i(),this.kGrpTips_i()];
		return t;
	};
	_proto.kImgBg_i = function () {
		var t = new eui.Image();
	...
	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kImgMain","kImgDecorate1","kImgDecorate2","kImgDecorate3","kGrpSnow","kBtn1","kBtn2","kBtn3","kGrpBtn","kGrpAction","kGrpGuide","kImgTipsBg","kImgTips","kGrpTips","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kImgBg_i(),this.kImgMain_i(),this.kImgDecorate1_i(),this.kImgDecorate2_i(),this.kImgDecorate3_i(),this.kGrpBtn_i(),this.kGrpAction_i(),this.kGrpGuide_i(),this.kGrpTips_i(),this._Rect2_i()];
		return t;
	};
	_proto.kImgBg_i = function () {
		var t = new eui.Image();
	...
	_proto.kGrpBtn_i = function () {
		...
		t.y = 524;
		t.layout = this._HorizontalLayout1_i();
		t.elementsContent = [this.kGrpSnow_i(),this._Group1_i(),this._Group2_i(),this._Group3_i()];
		return t;
	};
	_proto._HorizontalLayout1_i = function () {
		var t = new eui.HorizontalLayout();
