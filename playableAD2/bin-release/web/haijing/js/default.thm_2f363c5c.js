	...
	function MainViewDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kImgDecorate2","kImgMain","kImgDecorate1","kImgDecorate3","kBtn1","kBtn2","kBtn3","kGrpBtn","kGrpAction","kGrpGuide","kImgTipsBg","kImgTips","kGrpTips","kGrpMain"];
	...
	_proto.kGrpMain_i = function () {
		...
		t.verticalCenter = 0;
		t.width = 1280;
		t.elementsContent = [this.kImgBg_i(),this.kImgDecorate2_i(),this.kImgMain_i(),this.kImgDecorate1_i(),this.kImgDecorate3_i(),this.kGrpBtn_i(),this.kGrpAction_i(),this.kGrpGuide_i(),this.kGrpTips_i()];
		return t;
	};
	_proto.kImgBg_i = function () {
		var t = new eui.Image();
