	...
	_proto.kImgDrumstick5_i = function () {
		...
		t.anchorOffsetX = 24.33;
		t.anchorOffsetY = 17.33;
		t.source = "";
		t.x = 19.53;
		t.y = 25.63;
		return t;
	...
	_proto.kImgDrumstick1_i = function () {
		...
		t.anchorOffsetX = 26.4;
		t.anchorOffsetY = 23.6;
		t.source = "";
		t.x = 44.8;
		t.y = 28.03;
		return t;
	...
	_proto.kImgDrumstick3_i = function () {
		...
		t.anchorOffsetX = 19.8;
		t.anchorOffsetY = 15.2;
		t.source = "";
		t.x = 51.1;
		t.y = 45.1;
		return t;
	...
	_proto.kImgDrumstick4_i = function () {
		...
		t.anchorOffsetX = 11.8;
		t.anchorOffsetY = 11.4;
		t.source = "";
		t.x = 18.9;
		t.y = 47.3;
		return t;
	...
	_proto.kImgD2_i = function () {
		var t = new eui.Image();
		this.kImgD2 = t;
		t.anchorOffsetX = 23.75;
		t.anchorOffsetY = 21.25;
		t.scaleX = 0.8;
		t.scaleY = 0.8;
		t.source = "";
		t.x = 132;
