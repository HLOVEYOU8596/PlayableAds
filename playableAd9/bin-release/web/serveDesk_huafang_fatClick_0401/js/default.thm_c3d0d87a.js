	...
	function MainViewDevSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgPeople1","kImgMenu1","kImgOrder1","kImgOrder2","kImgRight1","kImgRight2","kGrpMenu1","kGrpPeople1","kImgbg2","kGrpBg","kGrpAction","kImgFood10","kImgFood8","kImgFood9","kImgFood11","kImgFood12","kImgFood13","kImgFood5","kImgFood6","kImgFood2","kImgFood7","kImgFood4","kImgFood1","kImgFood3","kImgError","kGrpMenu","kGrpSnow","kImgSwipe","kGrpGuide","kImgHand","kImgRect","kImgChoice1","kImgChoice2","kGrpChoice","kGrpMain"];
	...
	_proto.kGrpMenu_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kImgFood10_i(),this.kImgFood8_i(),this.kImgFood9_i(),this.kImgFood11_i(),this.kImgFood12_i(),this.kImgFood13_i(),this.kImgFood5_i(),this.kImgFood6_i(),this.kImgFood2_i(),this.kImgFood7_i(),this.kImgFood4_i(),this.kImgFood1_i(),this.kImgFood3_i(),this.kImgError_i()];
		return t;
	};
	...
	function MainViewSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg1","kImgPeople1","kImgMenu1","kImgOrder1","kImgOrder2","kImgRight1","kImgRight2","kGrpMenu1","kGrpPeople1","kImgbg2","kGrpBg","kGrpAction","kImgFood10","kImgFood11","kImgFood12","kImgFood13","kImgFood9","kImgFood8","kImgFood5","kImgFood6","kImgFood2","kImgFood7","kImgFood4","kImgFood1","kImgFood3","kImgError","kGrpMenu","kGrpSnow","kImgSwipe","kGrpGuide","kImgHand","kImgRect","kImgChoice1","kImgChoice2","kGrpChoice","kGrpMain"];
	...
	_proto.kGrpMenu_i = function () {
		...
		t.right = 0;
		t.top = 0;
		t.elementsContent = [this.kImgFood10_i(),this.kImgFood11_i(),this.kImgFood12_i(),this.kImgFood13_i(),this.kImgFood9_i(),this.kImgFood8_i(),this.kImgFood5_i(),this.kImgFood6_i(),this.kImgFood2_i(),this.kImgFood7_i(),this.kImgFood4_i(),this.kImgFood1_i(),this.kImgFood3_i(),this.kImgError_i()];
		return t;
	};
	_proto.kImgFood10_i = function () {
		var t = new eui.Image();
