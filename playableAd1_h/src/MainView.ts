...
class MainView extends eui.Component implements eui.UIComponent {
    ...
    private noodles:egret.MovieClip;
    ...
    private async initUI() {
        this.noodles = <egret.MovieClip>await McManger.instance.getMcAtH5('noodles',noodles_j,noodles,'fei');
    ...
    private touchSecond() {
        ...
        egret.Tween.get(this.kGrpFood1).to({ x: 495, y: 385 }, 300, egret.Ease.sineOut).call(() => {
            ...
            this.kGrpFood1.removeChild(this.noodles);
            this.noodles = null;
            egret.Tween.get(this.kImgFood1).to({scaleX:1,scaleY:1},400,egret.Ease.elasticInOut);
            // this.kImgFood1.scaleX = this.kImgFood1.scaleY = 0.6;
            egret.Tween.get(this.geek).to({ x: 240 }, 400, egret.Ease.cubicOut).call(() => {
                ...
                this.setProgress(400, () => {
                    egret.Tween.get(this.kImgFood2).to({ x: 884, y: 369, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineIn);
    ...
    private touchFouth() {
        this.guide.clearHand();
        //x:633,y:131,0.8
        egret.Tween.get(this.kGrpFood1).to({ x: 705, y: 180 }, 300, egret.Ease.sineOut).to({ scaleX: 0.5, scaleY: 0.5 }, 100).wait(100).call(() => {
            this.kImgRight.scaleX = this.kImgRight.scaleY = 1;
    ...
    private onCompleteFood() {
        ...
        egret.Tween.get(this.kImgFood2).to({ x: 440, y: 178 }, 300, egret.Ease.sineOut).to({ scaleX: .75, scaleY: .75 }, 100).wait(100).call(() => {
