...
var MainView = (function (_super) {
    ...
    function MainView() {
        ...
        _this.arr = [new egret.Point(230, 544),
            new egret.Point(280, 390),
            new egret.Point(520, 549),
            new egret.Point(428, 549),
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, McManger.instance.getMcAtH5('noodles', noodles_j, noodles, 'fei')];
                    case 1:
                        _a.noodles = (_d.sent());
                        this.noodles.anchorOffsetX = this.noodles.width / 2;
                        this.noodles.anchorOffsetY = this.noodles.height / 2;
                        this.noodles.x = (this.kGrpFood1.width) / 2;
                        this.noodles.y = (this.kGrpFood1.height) / 2;
                        _b = this;
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _a = this;
                        return [4 /*yield*/, ParticleUtil.instance.getParticleAtH5(this.kGrpSnow, snowJson, snow)];
                    case 1:
                        _a.system = _b.sent();
    ...
    MainView.prototype.touchFirst = function () {
        ...
        this.kGrpFood1.addChild(this.noodles);
        this.noodles.gotoAndPlay(0, 1);
        this.noodles.scaleX = this.noodles.scaleY = (1.3 * 10 / 7) * 1.1;
        // this.noodles.once(egret.Event.COMPLETE,()=>{
        // },this)
        //x:218,y320
        // egret.Tween.get(this.kImgFood1).to({ scaleX: 1, scaleY: 1 }, 400, egret.Ease.elasticIn).call(() => {
        //     //TODO  播放进度条代码，传入回调
        this.setProgress(400, function () {
    ...
    MainView.prototype.touchSecond = function () {
        ...
        egret.Tween.get(this.kGrpFood1).to({ x: 495, y: 385 }, 300, egret.Ease.sineOut).call(function () {
            ...
            _this.kGrpFood1.removeChild(_this.noodles);
            _this.noodles = null;
            egret.Tween.get(_this.kImgFood1).to({ scaleX: 1, scaleY: 1 }, 400, egret.Ease.elasticInOut);
            // this.kImgFood1.scaleX = this.kImgFood1.scaleY = 0.6;
            egret.Tween.get(_this.geek).to({ x: 240 }, 400, egret.Ease.cubicOut).call(function () {
                ...
                _this.setProgress(400, function () {
                    egret.Tween.get(_this.kImgFood2).to({ x: 884, y: 369, scaleX: 0.7, scaleY: 0.7 }, 300, egret.Ease.sineIn);
    ...
    MainView.prototype.touchFouth = function () {
        ...
        this.guide.clearHand();
        //x:633,y:131,0.8
        egret.Tween.get(this.kGrpFood1).to({ x: 705, y: 180 }, 300, egret.Ease.sineOut).to({ scaleX: 0.5, scaleY: 0.5 }, 100).wait(100).call(function () {
            _this.kImgRight.scaleX = _this.kImgRight.scaleY = 1;
    ...
    MainView.prototype.onCompleteFood = function () {
        ...
        if (this.kProgress.value === 50)
            this.guide.clearHand();
        egret.Tween.get(this.kImgFood2).to({ x: 440, y: 178 }, 300, egret.Ease.sineOut).to({ scaleX: .75, scaleY: .75 }, 100).wait(100).call(function () {
