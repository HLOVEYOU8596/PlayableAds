	...
	_proto.kGrpMain_i = function () {
		...
		t.x = 0;
		t.y = 0;
		t.elementsContent = [this.kImgBg_i(),this.kFood4_i(),this.kFood3_i(),this.kFood2_i(),this.kFood1_i(),this.kGrpCoke_i(),this.kGrpAction_i(),this.kGrpMask_i(),this.kGrpPeople1_i(),this.kGrpPeople2_i(),this.kImgSwipe_i(),this.kRecEnd_i(),this.kImgFloat1_i(),this.kImgFloat2_i(),this.kGrpGuide_i(),this.kGrpAlert_i()];
		return t;
	};
	...
	_proto.kGrpAlert_i = function () {
		...
		t.visible = false;
		t.width = 541;
		t.elementsContent = [this.kGrpTopic_i(),this.kImgLux_i(),this.kGrpIn_i(),this.kBtnContinue_i()];
		return t;
	};
	_proto.kGrpTopic_i = function () {
		var t = new eui.Group();
		this.kGrpTopic = t;
		t.anchorOffsetX = 271.34;
		t.anchorOffsetY = 62.06;
		t.height = 136;
		t.rotation = -10;
		t.scaleX = 0;
		t.scaleY = 0;
		t.x = 254;
		t.y = 116;
		t.elementsContent = [this.kImgTopic_i(),this.kImgTips_i()];
		return t;
	};
	...
	_proto.kGrpIn_i = function () {
		...
		t.elementsContent = [this.kImgCoin_i(),this.kImgKey_i(),this.kImgDiamond_i()];
		return t;
	};
	...
	function GameMainSkin() {
		_super.call(this);
		this.skinParts = ["kImgBg","kFood4","kFood3","kFood2","kFood1","kImgCoke1","kImgCoke2","kImgCoke3","kGrpCoke","kGrpAction","kImgXu","kGrpMask","kImgPeople1","kImgAlert1","kImgOrder1","kImgOrder2","kGrpMenu1","kGrpPeople1","kImgPeople2","kImgAlert2","kImgOrder3","kImgOrder4","kGrpMenu2","kGrpPeople2","kGrpGuide","kImgSwipe","kRecEnd","kImgFloat1","kImgFloat2","kImgTopic","kImgTips","kGrpTopic","kImgLux","kImgCoin","kImgKey","kImgDiamond","kGrpIn","kBtnContinue","kGrpAlert","kGrpMain","kGrpContent"];
