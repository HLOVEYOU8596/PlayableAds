...
var GameMain = (function (_super) {
    ...
    */
    ...
    GameMain.prototype.clikButton4 = function () {
        ...
        GuideStep.instance.clearHand();
        var a = 0;
        var tim = new egret.Timer(150, 4);
        tim.start();
        tim.addEventListener(egret.TimerEvent.TIMER, function () {
            _this.foodArr[a].showTomoto();
            a++;
        }, this);
        tim.once(egret.TimerEvent.TIMER_COMPLETE, function () {
            tim.stop();
            tim = null;
            GuideStep.instance.moveHand(_this.clikButton5.bind(_this, true));
        }, this);
    };
    GameMain.prototype.clikButton5 = function () {
        ...
        tim.start();
        tim.addEventListener(egret.TimerEvent.TIMER, function () {
            _this.foodArr[a].showFrties();
            a++;
        }, this);
        tim.once(egret.TimerEvent.TIMER_COMPLETE, function () {
            tim.stop();
            tim = null;
            GuideStep.instance.moveHand(_this.clikButton6.bind(_this, true));
        }, this);
    };
    GameMain.prototype.clikButton6 = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _this = this;
            var imgArr, indexArr, pointArr, tim, i;
            return __generator(this, function (_a) {
                GuideStep.instance.clearHand();
                imgArr = [this.kImgOrder3, this.kImgOrder4, this.kImgOrder1];
                indexArr = [0, 2, 1];
                pointArr = [new egret.Point(586, 140), new egret.Point(586, 128), new egret.Point(862, 140)];
                tim = new egret.Timer(500, 3);
                i = 0;
                tim.addEventListener(egret.TimerEvent.TIMER, function () { return __awaiter(_this, void 0, void 0, function () {
                    ...
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                point = this.foodArr[indexArr[i]].localToGlobal();
                                return [4 /*yield*/, ParticleUtil.instance.getParticleAtH5(this.kGrpAction, coinJson, coin, point.x + 50, point.y + 70, 500)];
                            case 1:
                                x = _a.sent();
                                x.scaleX = x.scaleY = 0.5;
                                this.upIndex(this.foodArr[indexArr[i]], this.kGrpMain);
                                egret.Tween.get(this.foodArr[indexArr[i]]).to({ x: pointArr[i].x, y: pointArr[i].y, scaleX: .6, scaleY: .6 }, 300).call(function () {
                                    _this.kGrpMain.removeChild(_this.foodArr[indexArr[i]]);
                                    imgArr[i].source = main_complete;
                                    // if (i == 2) GuideStep.instance.moveHand(this.openPlateForm.bind(this));
                                    if (i == 2)
                                        GuideStep.instance.moveHand(_this.clickButton9.bind(_this));
                                    i++;
                                });
                                return [2 /*return*/];
                        }
    ...
    GameMain.prototype.clickButton9 = function () {
        var _this = this;
        GuideStep.instance.clearHand();
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, ParticleUtil.instance.getParticleAtH5(this.kGrpGuide, coinJson, coin, this.kImgOrder1.localToGlobal().x + 50, this.kImgOrder1.localToGlobal().y + 30, 500)];
                    case 1:
                        x = _a.sent();
                        x.scaleX = x.scaleY = 0.5;
                        if (this.endType) {
                            this.setTimeCallBack(1200, function () { return __awaiter(_this, void 0, void 0, function () {
                                var _this = this;
                                var mm;
                                return __generator(this, function (_a) {
                                    switch (_a.label) {
                                        case 0:
                                            ...
                                            return [4 /*yield*/, McManger.instance.getMcAtH5('box', box_j, box)];
                                        case 1:
                                            mm = _a.sent();
                                            ...
                                            mm.once(egret.Event.COMPLETE, function () {
                                                _this.playCaidai(400, 2000);
                                                _this.kGrpAlert.removeChild(mm);
                                                egret.Tween.get(_this.kGrpIn).to({ scaleX: 1, scaleY: 1 }, 500, egret.Ease.elasticOut).call(function () {
                                                    egret.Tween.removeTweens(_this.kGrpIn);
                                                    egret.Tween.get(_this.kGrpIn, { loop: true }).to({ scaleX: 0.9, scaleY: 0.9 }, 300).to({ scaleX: 1, scaleY: 1 }, 600);
                                                    _this.kGrpTopic.y = -200;
                                                    egret.Tween.get(_this.kGrpTopic).to({ scaleX: 1, scaleY: 1, y: 140 }, 400, egret.Ease.elasticOut).to({ y: 116 }).call(function () {
                                                        egret.Tween.removeTweens(_this.kGrpTopic);
                                                        egret.Tween.get(_this.kGrpTopic, { loop: true })
                                                            .to({ scaleX: 0.9, scaleY: 0.9 }, 200).to({ scaleX: 1, scaleY: 1 }, 200)
                                                            .to({ scaleX: 0.9, scaleY: 0.9 }, 200).to({ scaleX: 1, scaleY: 1 }, 200)
                                                            .to({ scaleX: 0.9, scaleY: 0.9 }, 200).to({ scaleX: 1, scaleY: 1 }, 200)
                                                            .to({ y: 50 }, 200).to({ y: 116 }, 400);
                                                    });
                                                    egret.Tween.get(_this.kBtnContinue).to({ scaleX: 1, scaleY: 1 }, 300);
                                                });
                                                egret.Tween.get(_this.kImgLux).to({ scaleX: 1, scaleY: 1 }, 300).call(function () {
                                                    egret.Tween.removeTweens(_this.kImgLux);
                                                    egret.Tween.get(_this.kImgLux, { loop: true }).to({ rotation: 360 }, 6000);
                                                });
                                            }, this);
                                            return [2 /*return*/];
                                    }
