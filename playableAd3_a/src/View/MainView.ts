...
class MainView extends eui.Component implements eui.UIComponent {
    ...
    //引导相关变量
    private guideArr = [new egret.Point(527, 632), new egret.Point(527, 632), new egret.Point(527, 632),   
    new egret.Point(674, 632), new egret.Point(674, 632), new egret.Point(714, 632),
